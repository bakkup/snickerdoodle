...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_dshot_bb_2_0 -prefix
--               design_1_dshot_bb_2_0_ design_1_dshot_bb_0_0_sim_netlist.vhdl
...
entity design_1_dshot_bb_2_0_generic_bit_sync is
  port (
    CLK : in STD_LOGIC;
...
end design_1_dshot_bb_2_0_generic_bit_sync;

architecture STRUCTURE of design_1_dshot_bb_2_0_generic_bit_sync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dshot_bb_2_0_generic_counter is
  port (
    CLK : in STD_LOGIC;
...
end design_1_dshot_bb_2_0_generic_counter;

architecture STRUCTURE of design_1_dshot_bb_2_0_generic_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dshot_bb_2_0_generic_stream is
  port (
    CLK : in STD_LOGIC;
...
end design_1_dshot_bb_2_0_generic_stream;

architecture STRUCTURE of design_1_dshot_bb_2_0_generic_stream is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_dshot_bb_2_0_generic_stream__parameterized1\ is
  port (
    CLK : in STD_LOGIC;
    bit_stream : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of \design_1_dshot_bb_2_0_generic_stream__parameterized1\ : entity is "generic_stream";
end \design_1_dshot_bb_2_0_generic_stream__parameterized1\;

architecture STRUCTURE of \design_1_dshot_bb_2_0_generic_stream__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dshot_bb_2_0_dshot is
  port (
    bit_stream : out STD_LOGIC;
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
...
end design_1_dshot_bb_2_0_dshot;

architecture STRUCTURE of design_1_dshot_bb_2_0_dshot is
...
ones: entity work.\design_1_dshot_bb_2_0_generic_stream__parameterized1\
     port map (
      AR(0) => reset_IBUF,
      CLK => clk_IBUF_BUFG,
...
u_bit_sync: entity work.design_1_dshot_bb_2_0_generic_bit_sync
     port map (
      AR(0) => reset_IBUF,
      CLK => clk_IBUF_BUFG,
...
u_sync_1ms: entity work.design_1_dshot_bb_2_0_generic_counter
     port map (
      AR(0) => reset_IBUF,
      CLK => clk_IBUF_BUFG,
      D(15) => u_sync_1ms_n_2,
...
zeros: entity work.design_1_dshot_bb_2_0_generic_stream
     port map (
      AR(0) => reset_IBUF,
      CLK => clk_IBUF_BUFG,
      stream_out_sig => stream_out_sig,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dshot_bb_2_0_dshot_bb is
  port (
    bit_stream : out STD_LOGIC;
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
...
end design_1_dshot_bb_2_0_dshot_bb;

architecture STRUCTURE of design_1_dshot_bb_2_0_dshot_bb is
begin
uut: entity work.design_1_dshot_bb_2_0_dshot
     port map (
...
entity design_1_dshot_bb_2_0 is
  ...
  attribute NotValidForBitStream of design_1_dshot_bb_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_dshot_bb_2_0 : entity is "design_1_dshot_bb_0_0,dshot_bb,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_dshot_bb_2_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_dshot_bb_2_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_dshot_bb_2_0 : entity is "dshot_bb,Vivado 2018.2";
end design_1_dshot_bb_2_0;

architecture STRUCTURE of design_1_dshot_bb_2_0 is
...
begin
U0: entity work.design_1_dshot_bb_2_0_dshot_bb
     port map (
      bit_stream => bit_stream,
      clk => clk,
      enable => enable,
