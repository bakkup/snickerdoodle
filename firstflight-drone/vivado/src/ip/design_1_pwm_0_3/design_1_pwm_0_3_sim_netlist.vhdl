...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_pwm_0_3 -prefix
--               design_1_pwm_0_3_ design_1_pwm_0_1_sim_netlist.vhdl
...
entity design_1_pwm_0_3_pwm is
  port (
...
end design_1_pwm_0_3_pwm;

architecture STRUCTURE of design_1_pwm_0_3_pwm is
  signal count_sig1 : STD_LOGIC;
  ...
  signal output_sig0 : STD_LOGIC;
  signal \output_sig0_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \output_sig0_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \output_sig0_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \output_sig0_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \output_sig0_carry__0_n_0\ : STD_LOGIC;
  signal \output_sig0_carry__0_n_1\ : STD_LOGIC;
  signal \output_sig0_carry__0_n_2\ : STD_LOGIC;
  signal \output_sig0_carry__0_n_3\ : STD_LOGIC;
  signal \output_sig0_carry__1_i_1_n_0\ : STD_LOGIC;
  signal output_sig0_carry_i_1_n_0 : STD_LOGIC;
  signal output_sig0_carry_i_2_n_0 : STD_LOGIC;
  signal output_sig0_carry_i_3_n_0 : STD_LOGIC;
  signal output_sig0_carry_i_4_n_0 : STD_LOGIC;
  signal output_sig0_carry_n_0 : STD_LOGIC;
  signal output_sig0_carry_n_1 : STD_LOGIC;
  signal output_sig0_carry_n_2 : STD_LOGIC;
  signal output_sig0_carry_n_3 : STD_LOGIC;
  ...
  signal NLW_output_sig0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_output_sig0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_output_sig0_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_output_sig0_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
output_sig0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => output_sig0_carry_n_0,
      CO(2) => output_sig0_carry_n_1,
      CO(1) => output_sig0_carry_n_2,
      CO(0) => output_sig0_carry_n_3,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => NLW_output_sig0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => output_sig0_carry_i_1_n_0,
      S(2) => output_sig0_carry_i_2_n_0,
      S(1) => output_sig0_carry_i_3_n_0,
      S(0) => output_sig0_carry_i_4_n_0
    );
\output_sig0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => output_sig0_carry_n_0,
      CO(3) => \output_sig0_carry__0_n_0\,
      CO(2) => \output_sig0_carry__0_n_1\,
      CO(1) => \output_sig0_carry__0_n_2\,
      CO(0) => \output_sig0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_output_sig0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \output_sig0_carry__0_i_1_n_0\,
      S(2) => \output_sig0_carry__0_i_2_n_0\,
      S(1) => \output_sig0_carry__0_i_3_n_0\,
      S(0) => \output_sig0_carry__0_i_4_n_0\
    );
\output_sig0_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\output_sig0_carry__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\output_sig0_carry__0_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\output_sig0_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\output_sig0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \output_sig0_carry__0_n_0\,
      CO(3 downto 1) => \NLW_output_sig0_carry__1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => output_sig0,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_output_sig0_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \output_sig0_carry__1_i_1_n_0\
    );
\output_sig0_carry__1_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
output_sig0_carry_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
output_sig0_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
output_sig0_carry_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
output_sig0_carry_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
entity design_1_pwm_0_3 is
  ...
  attribute NotValidForBitStream of design_1_pwm_0_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_pwm_0_3 : entity is "design_1_pwm_0_1,pwm,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_pwm_0_3 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_pwm_0_3 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_pwm_0_3 : entity is "pwm,Vivado 2018.2";
end design_1_pwm_0_3;

architecture STRUCTURE of design_1_pwm_0_3 is
...
begin
U0: entity work.design_1_pwm_0_3_pwm
     port map (
      clk => clk,
